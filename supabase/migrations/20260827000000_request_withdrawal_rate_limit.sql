-- Semana 1 / F09: rate limit inside request_withdrawal
--
-- Enforced at the RPC layer so it applies even to direct Supabase SDK calls
-- that bypass the BFF. Limit: 5 withdrawal attempts per user per 24 hours.
...
begin
  ...
  -- Protects against rapid multi-attempt abuse even via direct SDK calls.
  ...
  -- V07: cumulative monthly KYC gate (migration 20260826140000)
