...
export const copy = {
  ...
  bet: {
    ...
    closedDescCommunity:
      "O prazo encerrou. O criador deve definir SIM ou NÃO para liquidar e pagar quem acertou.",
  ...
  auth: {
    ...
    phoneLabel: "Telefone",
    handleLabel: "Usuário (@)",
    handleHint: "3 a 20 caracteres. Letras, números e _",
    handleInvalid: "Informe um @ válido (3-20 caracteres, letras/números/_).",
  ...
  traffic: {
    liveHeroTitle: "Evento ao vivo agora",
    liveHeroHint: "1 minuto para apostar · próximo slot após o encerramento",
    nextEventTitle: "Próximo evento em",
    waitingNoSchedule: "Aguardando próximo slot",
    waitingNoScheduleHint: "Nenhum template pronto no catálogo ou scheduler pausado.",
    lastEndedPrefix: "Último encerrado às",
    endedTab: "Encerrados",
    recentEndedTitle: "Últimos encerrados",
    outcomeSectionTitle: "O que aconteceu",
    outcomePendingHint: "O resultado oficial pode levar alguns instantes após o encerramento.",
  },
  ...
  leagues: {
    ...
    subtitle: "Crie grupos com amigos e compita no ranking da temporada.",
    create: "Criar liga",
    ...
    kickMember: "Remover",
    transferOwnership: "Transferir dono",
    advanceSeason: "Encerrar temporada",
    ...
    joinHint: "Peça o código de 8 letras para quem criou a liga.",
    private: "Privada (só com código)",
    public: "Pública (qualquer um vê)",
    ranking: "Ranking",
    season: (label: string) => `Temporada: ${label}`,
    scoreLine: (rank: number, total: number, score: number) =>
      `#${rank} de ${total} · score ${score}`,
    statsLine: (roi: number, volume: number, accuracy: number) =>
      `ROI ${(roi * 100).toFixed(0)}% · vol. ${volume.toFixed(0)} · precisão ${(accuracy * 100).toFixed(0)}%`,
    publicSection: "Ligas abertas",
    publicSearch: "Buscar liga pública",
    enterPublic: "Entrar",
    activity: "Atividade recente",
    loadingRanking: "Carregando ranking…",
    createError: "Erro ao criar liga.",
    joinError: "Erro ao entrar na liga.",
    invalidCode: "Código inválido. Verifique e tente de novo.",
    leagueFull: "Liga cheia.",
    leaveError: "Erro ao sair da liga.",
    creatorLeaveError: "Transfira a liga ou exclua antes de sair.",
    joinSuccess: (name: string) => `Entrou na liga "${name}"!`,
    alreadyMember: "Você já está nessa liga.",
    linkCopied: "Link copiado!",
    codeCopied: "Código copiado!",
    dashboardCta: "Crie uma liga com amigos",
    dashboardCtaDesc: "Compete, sobe no ranking e ganha XP em grupo",
    viewFull: "Ver liga completa",
    rankingTab: "Ligas",
    ...
    weeklyTitle: "Bônus semanal da liga",
    weeklyHint: "Faça 1 previsão liquidada na temporada para liberar +50 XP",
    weeklyReady: "Bônus disponível — resgate agora",
    weeklyDone: "Bônus da semana resgatado",
    weeklyCta: "Prever",
    weeklyClaimed: (name: string) => `Bônus semanal resgatado na liga ${name}`,
    weeklyXp: (xp: number) => `+${xp} XP`,
    weeklyAlreadyClaimed: "Você já resgatou o bônus desta semana nesta liga.",
    weeklyNotEligible: "Faça pelo menos 1 previsão liquidada na temporada atual.",
    weeklyClaimError: "Não foi possível resgatar o bônus.",
    hallPodium: (ranks: string) => `Pódio: ${ranks}`,
  ...
  partner: {
    ...
    landing: {
      ...
      promotionRequiredHint: "Descreva onde você vai divulgar a ViaX.",
      bioMinHint: "Mínimo de 20 caracteres.",
      applySuccess: "Candidatura enviada! Nossa equipe analisa em alguns dias úteis.",
      applyAlreadyPending: "Você já tem uma candidatura em análise.",
      applyAlreadyPartner: "Sua conta já está no programa creator.",
    ...
    adminPreviewTitle: "Modo visualização (admin)",
    adminPreviewDesc:
      "Você está vendo o Creator Hub sem conta creator aprovada. Métricas zeradas até aprovar em Admin → Creators.",
    adminPreviewLinkHint: "O link /r/ só funciona após aprovação do programa creator.",
    adminPreviewGoAdmin: "Ir para Creators (admin)",
    stats: {
    ...
    subCreatorsDisabled:
      "Sub-creators não está habilitado para sua conta. Peça ao admin em Creators ou aguarde liberação.",
  ...
  admin: {
    ...
    nav: {
      ...
      events: "Eventos",
      football: "Futebol",
      trafficEvents: "Trânsito · slots",
      cpaFraud: "Fraude CPA",
    },
    trafficEvents: {
      title: "Eventos de trânsito",
      subtitle: "Catálogo eterno · 1 slot ao vivo · teste de câmera antes de liberar",
      newTemplate: "Novo template",
      editTemplate: "Editar template",
      save: "Salvar",
      testCamera: "Testar câmera",
      approveReady: "Aprovar para rotação",
      revokeReady: "Remover da rotação",
      deactivate: "Desativar",
      activate: "Ativar",
      ready: "Pronto",
      notReady: "Aguardando teste",
      active: "Ativo",
      inactive: "Inativo",
      lastTested: "Último teste",
      lastUsed: "Último uso",
      schedulerTitle: "Scheduler",
      durationLabel: "Duração do slot (segundos)",
      gapLabel: "Intervalo após o fim (segundos)",
      saveScheduler: "Salvar scheduler",
      nextStarts: "Próximo slot",
      currentSlot: "Slot atual",
      noCameras: "Nenhuma câmera online para esta região.",
      saved: "Template salvo.",
      readyDone: "Template liberado para sorteio.",
      readyRevoked: "Template removido da rotação.",
      schedulerSaved: "Scheduler atualizado.",
      empty: "Nenhum template cadastrado.",
      nameLabel: "Nome interno",
      questionLabel: "Pergunta",
      regionLabel: "Região",
      targetLabel: "Meta numérica",
    ...
    football: {
      ...
      autoApproveHint:
        "Desligado: jogos entram em Pendentes para revisão manual. Ligado: jogos futuros podem ir direto para Rascunhos.",
      ...
      syncDaysBackLabel: "Dias para trás no sync",
      syncDaysLabel: "Dias à frente no sync",
      syncBaseDateLabel: "Data-base da temporada (padrão: hoje)",
      syncBaseDateHint:
        "Usada para definir a temporada enviada à API-Football. Se não informar, usamos a data atual.",
      ...
      syncDone: "Sync concluído — valide Pendentes ou Rascunhos conforme sua configuração.",
      syncPartial: "Sync parcial: alguns jogos foram importados, mas houve erros.",
      syncApi403:
        "API-Football recusou a chave (403). Configure API_FOOTBALL_KEY no Worker e confira o plano na API-Sports.",
    ...
    events: {
      ...
      opsTitle: "Status Operacional dos Mercados",
      opsFootballTitle: "Futebol",
      opsTrafficTitle: "Trânsito / Gerais",
      opsCommunityTitle: "Comunidade",
      opsOtherTitle: "Outros",
      opsAutoRules: "Regras automáticas",
      opsLastRun: "Última execução",
      opsNoRun: "Sem execução registrada",
      opsOpenAdmin: "Abrir painel",
      opsLiveMarkets: "Mercados ao vivo",
      opsDraftMarkets: "Rascunhos",
      opsDisputeMarkets: "Em disputa",
      opsPendingReports: "Denúncias pendentes",
      opsPendingFixtures: "Jogos pendentes",
      opsEnabled: "Ativo",
      opsDisabled: "Inativo",
      ...
      editEvent: "Editar",
      cancel: "Cancelar",
      editingEventHint: "Alterando evento selecionado — use Cancelar para voltar ao modo criação.",
      editingPollHint: "Alterando enquete selecionada — use Cancelar para criar outra.",
      deleteEvent: "Excluir",
    ...
    partners: {
      ...
      referrals: "Indicados",
      subCreatorsEnable: "Habilitar Sub-creators",
      subCreatorsSaved: "Sub-creators atualizado.",
    },
    metrics: {
    ...
    risk: {
      ...
      cpaTitle: "Fraude CPA",
      cpaSubtitle:
        "Heurísticas automáticas (CPF duplicado, qualificação rápida) · CPA provisionado até o dia 8 do mês seguinte",
      referralTitle: "Conversões CPA",
      flaggedOnly: "Somente marcados",
      tagFraud: "Marcar suspeito",
      tagConfirm: "Confirmar fraude",
      tagClear: "Limpar tag",
      statusOpen: "Suspeito",
      statusConfirmed: "Fraude confirmada",
      statusCleared: "Limpo",
      statusResolved: "Resolvido",
      suspiciousSection: "Casos suspeitos (open)",
      confirmedSection: "Fraude confirmada",
      actionNoteLabel: "Motivo da ação (obrigatório)",
      actionNoteHint: "Mínimo 8 caracteres · registrado na auditoria",
      actionNoteRequired: "Informe o motivo com pelo menos 8 caracteres.",
      confirmNoteRequired: "Para confirmar fraude, preencha o motivo com pelo menos 8 caracteres.",
      destructiveRequiresConfirmed: "Ações destrutivas só funcionam em casos com status confirmed.",
      clearCpas: "Limpar CPAs com fraude",
      suspendPartners: "Bloquear afiliados com fraude",
      banUsers: "Banir usuários (soft-delete)",
      banUsersConfirm:
      ...
      noSuspicious: "Nenhum caso suspeito.",
    ...
    system: {
      ...
      defaultCpa: "CPA padrão (BRL)",
      cpaMinDeposit: "Depósito mínimo para CPA (BRL)",
    },
    finance: {
    ...
    bonuses: {
      title: "Bônus & Cash",
      subtitle: "Distribuição a usuários comuns · roleta · concessões manuais",
      totalCash: "Cash distribuído",
      spinCash: "Roleta (cash)",
      xpDistributed: "XP distribuído",
      recipients: "Usuários beneficiados",
      grantTitle: "Conceder bônus",
      grantCta: "Conceder",
      spinWeightsTitle: "Pesos da roleta",
      spinWeightsHint: "Ajuste probabilidades e prêmios. Alterações entram na trilha de auditoria.",
      ledgerTitle: "Histórico de distribuições",
    },
    community: {
      ...
      filterReported: "Com denúncia",
      betsCount: "Apostas",
      copyInvite: "Copiar link",
      inviteCopied: "Link copiado.",
      empty: "Nenhum evento de usuário comum.",
    },
    overview: {
