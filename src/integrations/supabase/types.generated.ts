  ...
  public: {
    Tables: {
      ...
      football_bets: {
        ...
        Relationships: [
          {
            foreignKeyName: "football_bets_market_id_fkey";
            columns: ["market_id"];
            isOneToOne: false;
            referencedRelation: "football_markets";
            referencedColumns: ["id"];
          },
          {
      ...
      football_fixtures: {
        Row: {
          ...
          review_status: Database["public"]["Enums"]["football_review_status"];
          reviewed_at: string | null;
          reviewed_by: string | null;
          season: number;
          status_short: string;
        ...
        Relationships: [
          {
            foreignKeyName: "football_fixtures_api_league_id_fkey";
      ...
      football_market_resolutions: {
        Row: {
          ...
          source: string;
          status: string;
          winning_outcome: Database["public"]["Enums"]["football_outcome"] | null;
        };
        Insert: {
          created_at?: string;
          goals_away?: number | null;
        ...
        Relationships: [
          {
            foreignKeyName: "football_market_resolutions_market_id_fkey";
            columns: ["market_id"];
            isOneToOne: false;
            referencedRelation: "football_markets";
            referencedColumns: ["id"];
      ...
      football_markets: {
        ...
        Relationships: [
          {
            foreignKeyName: "football_markets_fixture_id_fkey";
            columns: ["fixture_id"];
            isOneToOne: true;
            referencedRelation: "football_fixtures";
            referencedColumns: ["api_fixture_id"];
          },
        ];
      };
      league_members: {
      ...
      market_alerts: {
        ...
        Relationships: [
          {
            foreignKeyName: "market_alerts_market_id_fkey";
            columns: ["market_id"];
            isOneToOne: false;
            referencedRelation: "markets";
            referencedColumns: ["id"];
      ...
      markets: {
        Row: {
          ...
          status: Database["public"]["Enums"]["market_status"];
          target: number;
          traffic_template_id: string | null;
          trend: number;
          updated_at: string;
          visibility: string;
        };
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "markets_traffic_template_id_fkey";
      ...
      partner_commission_ledger: {
        Row: {
          ...
          released_to_balance_at: string | null;
      ...
      security_velocity_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "security_velocity_events_user_id_fkey";
            columns: ["user_id"];
            isOneToOne: false;
            referencedRelation: "leaderboard";
            referencedColumns: ["id"];
      ...
      traffic_event_templates: {
        ...
        Relationships: [
          {
            foreignKeyName: "traffic_event_templates_camera_id_fkey";
            columns: ["camera_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "traffic_event_templates_region_id_fkey";
            columns: ["region_id"];
            isOneToOne: false;
            referencedRelation: "regions";
            referencedColumns: ["id"];
      ...
      traffic_scheduler: {
        ...
        Relationships: [
          {
            foreignKeyName: "traffic_scheduler_current_market_id_fkey";
            columns: ["current_market_id"];
            isOneToOne: false;
            referencedRelation: "markets";
            referencedColumns: ["id"];
          },
          {
            foreignKeyName: "traffic_scheduler_last_template_id_fkey";
    ...
    Functions: {
      ...
      admin_approve_partner: {
        Args: {
          ...
          p_slug?: string;
          p_sub_creators_enabled?: boolean;
          p_tier?: string;
          p_user_id: string;
        };
        Returns: Json;
      ...
      admin_list_football_live: { Args: { p_limit?: number }; Returns: Json[] };
      ...
      admin_reject_football_fixture: {
        Args: { p_fixture_id: number; p_reason?: string };
        Returns: Json;
      };
      ...
      admin_set_partner_sub_creators: {
        Args: { p_enabled: boolean; p_user_id: string };
        Returns: Json;
      };
      admin_set_traffic_template_ready: {
        Args: { p_ready?: boolean; p_template_id: string };
        Returns: Json;
      };
      ...
      admin_test_traffic_template: {
        Args: { p_template_id: string };
        Returns: Json;
      };
      admin_trigger_lifecycle: { Args: never; Returns: Json };
      admin_update_casino_spin_weights: {
        Args: { p_weights: Json };
        Returns: Json;
      };
      ...
      admin_update_traffic_scheduler: {
        Args: { p_payload: Json };
        Returns: Json;
      };
      admin_upsert_camera: {
      ...
      admin_upsert_traffic_template: {
        Args: { p_payload: Json };
        Returns: Json;
      };
      admin_void_community_market: {
      ...
      assert_admin_action_note: { Args: { p_note: string }; Returns: undefined };
      assert_admin_mfa: { Args: never; Returns: undefined };
      ...
      football_assert_admin: { Args: never; Returns: undefined };
      football_derive_outcome: {
        Args: { p_goals_away: number; p_goals_home: number };
        Returns: Database["public"]["Enums"]["football_outcome"];
      };
      football_min_minority_ratio: { Args: never; Returns: number };
      football_run_acceptance_flow: { Args: never; Returns: Json };
      football_setting_json: {
        Args: { p_default?: Json; p_key: string };
        Returns: Json;
      };
      football_setting_num: {
        Args: { p_default: number; p_key: string };
        Returns: number;
      };
      get_active_events: { Args: never; Returns: Json };
      get_admin_actions_log: { Args: { p_limit?: number }; Returns: Json };
      get_admin_bonus_ledger: { Args: { p_limit?: number }; Returns: Json };
      get_admin_bonus_overview: { Args: { p_days?: number }; Returns: Json };
      ...
      get_traffic_public_state: { Args: never; Returns: Json };
      get_trending_traders: {
        Args: { p_limit?: number };
        Returns: {
          accuracy_7d: number;
          avatar: string;
      ...
      hash_cpf_document: { Args: { p_document: string }; Returns: string };
      ...
      is_admin_mfa_required: { Args: never; Returns: boolean };
      ...
      is_valid_cpf: { Args: { p_document: string }; Returns: boolean };
      ...
      monthly_withdrawn_brl_for_cpf_hash: {
        Args: { p_cpf_hash: string; p_timezone?: string };
        Returns: number;
      };
      normalize_cpf_digits: { Args: { p_document: string }; Returns: string };
      open_market: {
      ...
      payer_cluster_referring_partners: {
        Args: { p_cpf_hash: string };
        Returns: Json;
      };
      ...
      service_assert_velocity_limit: {
        Args: { p_action: string; p_device_hash?: string; p_ip_hash: string };
        Returns: Json;
      };
      ...
      service_fraud_cluster_sweep: { Args: never; Returns: Json };
      ...
      service_upsert_payment_identity: {
        Args: { p_document: string; p_source?: string; p_user_id: string };
        Returns: undefined;
      };
      ...
      settle_football_market: {
        Args: {
          ...
          p_goals_home?: number;
          p_market_id: string;
          p_winning: Database["public"]["Enums"]["football_outcome"];
        };
        Returns: Json;
      };
      settle_market: {
      ...
      spawn_traffic_slot_from_template: { Args: never; Returns: Json };
      ...
      tick_traffic_slots: { Args: never; Returns: Json };
    ...
    Enums: {
      ...
      football_outcome: "HOME" | "DRAW" | "AWAY";
      football_review_status: "pending_review" | "approved" | "rejected";
