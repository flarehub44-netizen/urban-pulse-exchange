...
async function addSecurityHeaders(response: Response): Promise<Response> {
  ...
  headers.set(
    ...
    [
      ...
      // 'strict-dynamic' propagates trust to scripts dynamically loaded by nonce'd scripts
      // (TanStack Start hydration, Vite HMR, Lovable preview overlay can inject helpers).
      `script-src-elem 'self' 'nonce-${nonce}' 'strict-dynamic' 'sha256-IAcu3JfpZWtobFI2HR0D0+8pISSU3BW2WJn791heS40=' 'sha256-zuArVEaD0JEWn0oRTsTDf0SIs1BWjJc1h+nvMc1w+6E=' 'sha256-IlBMqZFDe0MAWOyRZASsffMFCeHUSc6O/6HYUq1e6uY=' https://viax.life https://viax.lovable.app https://*.lovable.app https://*.lovable.dev https://cdn.gpteng.co`,
